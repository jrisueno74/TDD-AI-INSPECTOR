    ...
    sections: [
      ...
      // SECTION 2: BODY
      {
        ...
        children: [
          ...
          incidences.length === 0
            ...
            : new Table({
                ...
                rows: [
                  ...
                  ...incidences.map(inc => {
                    const exec = executiveSummary.find(e => e.id === inc.id);
                    return new TableRow({
                      children: [
                        new TableCell({
                          width: { size: 1800, type: WidthType.DXA },
                        ...
                        new TableCell({
                          width: { size: 3613, type: WidthType.DXA },
                          margins: { top: 100, bottom: 100, left: 100, right: 100 },
                          children: [new Paragraph({ children: [new TextRun({ text: exec ? exec.technicalDescription : inc.description, font: "Calibri", size: 18 })] })],
                        }),
                        new TableCell({
                          width: { size: 3613, type: WidthType.DXA },
                          margins: { top: 100, bottom: 100, left: 100, right: 100 },
                          children: [new Paragraph({ children: parseMarkdownToTextRuns(exec ? exec.executiveIntervention : (inc.aiFeedback || "Pendiente de revisión"), { font: "Calibri", size: 18 }) })],
                        }),
                      ],
                    });
                  })
          ...
          // 3. CAPEX ESTIMADO
          createHeading1("3. CAPEX ESTIMADO"),
          createBodyText("Resumen de costes estimados de reposición y restauración de la conformidad, basados en la base de datos de precios y los hallazgos registrados."),
          new Paragraph({ text: "", spacing: { before: 200 } }),
          
          ...(capexEstimation && capexEstimation.length > 0 ? [
            new Table({
              width: { size: PAGE_WIDTH, type: WidthType.DXA },
              columnWidths: [1500, 2500, 2500, 1500, 2000],
              borders: {
                top: { style: BorderStyle.SINGLE, size: 4, color: COLORS.LightBlue },
                bottom: { style: BorderStyle.SINGLE, size: 4, color: COLORS.LightBlue },
                left: { style: BorderStyle.SINGLE, size: 4, color: COLORS.LightBlue },
                ...
                new TableRow({
                  children: [
                    new TableCell({
                      ...
                      shading: { type: ShadingType.CLEAR, fill: COLORS.LightBlue },
                      margins: { top: 100, bottom: 100, left: 100, right: 100 },
                      children: [new Paragraph({ children: [new TextRun({ text: "Elemento", bold: true, font: "Calibri", size: 18 })] })],
                    }),
                    new TableCell({
                      width: { size: 2500, type: WidthType.DXA },
                      shading: { type: ShadingType.CLEAR, fill: COLORS.LightBlue },
                      margins: { top: 100, bottom: 100, left: 100, right: 100 },
                      children: [new Paragraph({ children: [new TextRun({ text: "Intervención", bold: true, font: "Calibri", size: 18 })] })],
                    }),
                    new TableCell({
                      width: { size: 2500, type: WidthType.DXA },
                      shading: { type: ShadingType.CLEAR, fill: COLORS.LightBlue },
                      margins: { top: 100, bottom: 100, left: 100, right: 100 },
                      children: [new Paragraph({ children: [new TextRun({ text: "Justificación", bold: true, font: "Calibri", size: 18 })] })],
                    }),
                    new TableCell({
                      width: { size: 1500, type: WidthType.DXA },
                      shading: { type: ShadingType.CLEAR, fill: COLORS.LightBlue },
                      margins: { top: 100, bottom: 100, left: 100, right: 100 },
                      children: [new Paragraph({ children: [new TextRun({ text: "Coste Estimado", bold: true, font: "Calibri", size: 18 })] })],
                    }),
                  ],
                }),
                ...capexEstimation.map(item => new TableRow({
                  children: [
                    new TableCell({
                      width: { size: 1500, type: WidthType.DXA },
                      margins: { top: 100, bottom: 100, left: 100, right: 100 },
                      children: [new Paragraph({ children: [new TextRun({ text: item.element, font: "Calibri", size: 18 })] })],
                    }),
                    new TableCell({
                      width: { size: 2500, type: WidthType.DXA },
                      margins: { top: 100, bottom: 100, left: 100, right: 100 },
                      children: [new Paragraph({ children: [new TextRun({ text: item.intervention, font: "Calibri", size: 18 })] })],
                    }),
                    new TableCell({
                      width: { size: 2500, type: WidthType.DXA },
                      margins: { top: 100, bottom: 100, left: 100, right: 100 },
                      children: [new Paragraph({ children: [new TextRun({ text: item.justification, font: "Calibri", size: 18 })] })],
                    }),
                    new TableCell({
                      width: { size: 1500, type: WidthType.DXA },
                      margins: { top: 100, bottom: 100, left: 100, right: 100 },
                      children: [new Paragraph({ alignment: AlignmentType.RIGHT, children: [new TextRun({ text: `${item.estimatedCost.toLocaleString('es-ES')} €`, font: "Calibri", size: 18, bold: true })] })],
                    }),
                  ],
                })),
                new TableRow({
                  children: [
                    new TableCell({
                      ...
                      shading: { type: ShadingType.CLEAR, fill: COLORS.LightBlue },
                      margins: { top: 100, bottom: 100, left: 100, right: 100 },
                      children: [new Paragraph({ alignment: AlignmentType.RIGHT, children: [new TextRun({ text: "TOTAL CAPEX ESTIMADO", bold: true, font: "Calibri", size: 18 })] })],
                    }),
                    new TableCell({
                      width: { size: 1500, type: WidthType.DXA },
                      shading: { type: ShadingType.CLEAR, fill: COLORS.LightBlue },
                      margins: { top: 100, bottom: 100, left: 100, right: 100 },
                      children: [new Paragraph({ alignment: AlignmentType.RIGHT, children: [new TextRun({ text: `${capexEstimation.reduce((sum, item) => sum + (item.estimatedCost || 0), 0).toLocaleString('es-ES')} €`, bold: true, font: "Calibri", size: 18 })] })],
                    }),
                  ],
                })
              ],
            ...
            createBodyText("No se han registrado incidencias que requieran estimación de CAPEX.")
          ]),

          new Paragraph({ children: [new PageBreak()] }),

          // 4. NOTAS PARA REVISIÓN EN OFICINA - IA
          createHeading1("4. NOTAS PARA REVISIÓN EN OFICINA (IA)"),
          new Table({
            width: { size: PAGE_WIDTH, type: WidthType.DXA },
          ...
          createHeading2("4.1 Checklist Final"),
          ...parseAiChecklist(checklist),

          new Paragraph({ children: [new PageBreak()] }),

          // 5. METODOLOGÍA Y FIRMA
          createHeading1("5. ANEXOS Y DECLARACIÓN"),
          createHeading2("5.1 Metodología y Limitaciones"),
